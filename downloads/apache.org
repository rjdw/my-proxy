          ...
          <ul class="nav navbar-nav navbar-justified">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/foundation/contributing.html#Bitcoin">&nbsp;&nbsp;Using Bigcoin</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					...
					<ul>
						<li>200M+ lines of code in&nbsp;stewardship</li>
						<li>1,058,321,099 lines of code&nbsp;committed</li>
						<li>3,022,836 code commits</li>
						<li>730 individual ASF Members</li>
						<li>7,000 Apache code committers</li>
						<li>All volunteer community</li>
					<!-- Note: br not allowed here -->
					</ul>
					<ul>
						<li>350+ Projects and Initiatives</li>
						<li>300+ Top-Level Projects</li>
						<li>52 podlings in the Apache Incubator</li>
					</ul>
					<p><a href="https://s.apache.org/ASF20thAnniversary">$20B+ worth of Apache Open Source software products are
							made available to the public-at-large at 100% no cost, and benefit billions of users around
							the&nbsp;world.</a>
					</p>
				</div>
				<div class="col-sm-6">
					<!-- Slideshow container -->
					<div id="apacheQuotes" class="slideshow-container">

						<!-- Full-width slides/quotes -->
						<div class="mySlides">
							<blockquote class="text-center">
								<p>"The most popular open source software is&nbsp;Apache&hellip;"</p>
								<footer>DZone, <cite title="What Open Source Software Do You Use?">âWhat Open Source Software Do You&nbsp;Use?â</cite></footer>
							</blockquote>
						</div>
					...
					<div class="video-responsive">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/ik6Hs0eZX3U" frameborder="0"
			...
			<div class="highlights">
				<article class="card">
					<a href="http://www.apache.org/foundation/reports.html">
						<img class="img-responsive" src="img/annual-reportFY2019-thumb.png" alt="Apache Annual Report" />
						<div class="card-content">
							<h4>Foundation Reports</h4>
				...
				<article class="card">
					<a href="https://www.apachecon.com/">
						...
						<div class="card-content">
							<h4>Apache Conferences</h4>
							<p>"Tomorrow's Technology Today" since 1998. Intentionally intimate, offering unparalleled educational,
								networking, and collaboration opportunities. 2019 events are taking place in Washington DC, Chicago, Las
								Vegas, and Berlin. Join&nbsp;us!</p>
						</div>
					</a>
				</article>
			</div>
...
<!-- Apache Statements Section -->
	...
	<section class="bg-info">
		<div class="container">
			<p>The ASF develops, shepherds, and incubates hundreds of freely-available, enterprise-grade projects that serve
				as the backbone for some of the most visible and widely used applications in computing today. Through the ASF's
				merit-based process known as <a href="http://www.apache.org/theapacheway/">"The Apache Way,"</a> more
				than <a href="http://community.zones.apache.org/map.html">730 individual volunteer Members and 7,000+ code
					Committers</a> across six continents successfully collaborate on innovations in Artificial Intelligence and
				Deep Learning, Big Data, Build Management, Cloud Computing, Content Management, DevOps, IoT and Edge Computing,
				Mobile, Servers, and Web Frameworks, <a href="https://projects.apache.org/projects.html?category">among other&nbsp;categories</a>.</p>

			<p><strong>APACHE IS &hellip;</strong></p>

			<p><strong>OPEN:</strong> The Apache Software Foundation provides support for 300+ Apache Projects and their
				Communities, furthering its mission of providing Open Source software for the public&nbsp;good.</p>

			<p><strong>INNOVATION:</strong> Apache Projects are defined by <a
					href="http://www.apache.org/theapacheway/index.html">collaborative, consensus-based processes</a>, an
				open, pragmatic software license and a desire to create high quality software that leads the way in its&nbsp;field.
			</p>

			<p><strong>COMMUNITY:</strong> We are a <a href="http://community.apache.org/">community of developers and
					users</a> of enterprise-grade, Open Source Apache projects used in every Internet-connected country on the&nbsp;planet.</p>
		</div>
	</section>
	<!-- / Apache Statements Section -->
<!-- / Apache Statements Section -->
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <div class="tabbable tabs-left visible-md-inline visible-lg-inline">
              <ul class="nav nav-tabs">
                  ...
                  <li class='active'>
                    <a href="#4" data-toggle="tab">Apache Portals</a>
                  </li>
                
                  <li >
                    <a href="#5" data-toggle="tab">Apache Commons JEXL</a>
                  </li>
                
                  <li >
                    <a href="#6" data-toggle="tab">Apache Crunch</a>
                  </li>
          ...
          <div class="col-md-9 col-sm-12">
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="4">
                  <div class="row">
                    <div class="col-sm-2">
                      <img class="img-responsive center-block" src="/logos/res/portals/default.png" alt="Logo">
                    </div>
                    <div class="col-sm-10">
                      <h4 class="no-btm-margin"><a href="http://portals.apache.org">Apache Portals</a></h4>
                      <p>The Apache Portals project provides various software products, including Apache Jetspeed-2, Apache Pluto, and Apache Portals Applications.</p>
                      <a class="btn btn-default btn-sm" href="http://portals.apache.org" role="button">Learn More...</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade in " id="5">
                  <div class="row">
                    <div class="col-sm-2">
                      <img class="img-responsive center-block" src="/logos/res/commons/default.png" alt="Logo">
                    </div>
                    <div class="col-sm-10">
                      <h4 class="no-btm-margin"><a href="http://commons.apache.org/jexl/">Apache Commons JEXL</a></h4>
                      <p>Jexl is an implementation of the JSTL Expression Language with extensions.</p>
                      <a class="btn btn-default btn-sm" href="http://commons.apache.org/jexl/" role="button">Learn More...</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade in " id="6">
                  <div class="row">
                    <div class="col-sm-2">
                      <img class="img-responsive center-block" src="/logos/res/crunch/default.png" alt="Logo">
                    </div>
                    <div class="col-sm-10">
                      <h4 class="no-btm-margin"><a href="http://crunch.apache.org">Apache Crunch</a></h4>
                      <p>The Apache Crunch Java library provides a framework for writing, testing, and running MapReduce pipelines. Its goal is to make pipelines that are composed of many user-defined functions simple to write, easy to test, and efficient to run.

Running on top of Hadoop MapReduce and Apache Spark, the Apache Crunch™...</p>
                      <a class="btn btn-default btn-sm" href="http://crunch.apache.org" role="button">Learn More...</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <h3>Incubating Project<span class="visible-md-inline visible-lg-inline">s</span></h3>
			<p>The Apache Incubator is the entry path into The Apache Software Foundation for projects and codebases wishing to become part of the Foundationâs efforts. 
          ...
          <div class="col-md-3 col-sm-12">
            ...
            <div class="tabbable tabs-left visible-md-inline visible-lg-inline">
              <ul class="nav nav-tabs">
                  ...
                  <li class='active'>
                    <a href="#1" data-toggle="tab">Apache Doris (Incubating)</a>
                  </li>
                
                  <li >
                    <a href="#2" data-toggle="tab">Apache DataSketches (Incubating)</a>
                  </li>
                
                  <li >
                    <a href="#3" data-toggle="tab">Apache SDAP (Incubating)</a>
                  </li>
          ...
          <div class="col-md-9 col-sm-12">
            <div class="tab-content">
                ...
                <div class="tab-pane fade in " id="2">
                  <div class="row">
                    <div class="col-sm-2">
                      <img class="img-responsive center-block" src="/logos/res/datasketches/default.png" alt="Logo">
                    </div>
                    <div class="col-sm-10">
                      <h4 class="no-btm-margin"><a href="http://datasketches.incubator.apache.org/">Apache DataSketches (Incubating)</a></h4>
                      <p>DataSketches is an open source, high-performance library of stochastic streaming algorithms commonly called "sketches" in the data sciences. Sketches are small, stateful programs that process massive data as a stream and can provide approximate answers, with mathematical guarantees, to computationally difficult queries orders-of-magnitude faster than traditional, exact methods.</p>
                      <a class="btn btn-default btn-sm" href="http://datasketches.incubator.apache.org/" role="button">Learn More...</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade in " id="3">
                  <div class="row">
                    <div class="col-sm-2">
                      <img class="img-responsive center-block" src="/logos/res/sdap/default.png" alt="Logo">
                    </div>
                    <div class="col-sm-10">
                      <h4 class="no-btm-margin"><a href="http://sdap.incubator.apache.org/">Apache SDAP (Incubating)</a></h4>
                      <p>SDAP is an integrated data analytic center for Big Science problems.</p>
                      <a class="btn btn-default btn-sm" href="http://sdap.incubator.apache.org/" role="button">Learn More...</a>
                    </div>
                  </div>
                </div>
				...
				<article class="card">
					<div class="content">
						<span class="label label-danger">Foundation Blog</span>
                          ...
                          <h5><a class="entryTitle" href="https://blogs.apache.org/foundation/entry/the-apache-news-round-up151">The Apache News Round-up: week ending 6 December 2019 </a></h5>
                          <p>Welcome December! --let&#39;s take a look back at
...
week: 
  ...
  <p> </p> 
  <p>Support Apache â help the ASF continue to provide...</p></p>
                          <hr>
				...
				<article class="card">
					<div class="content">
						<span class="label label-danger">Conferences</span>
                          ...
                          <h5><a class="entryTitle" href="https://blogs.apache.org/conferences/entry/the-apache-software-foundation-announces3">The ApacheÂ® Software Foundation Announces Program Highlights for ApacheConâ¢ Europe</a></h5>
                          <p><div><strong><em>Momentum Builds for Official Global Conference Series of the World&#39;s largest Open Source Foundation</em></strong></div> 
  <div><strong><br></strong></div> 
  <div><strong>Wakefield, MA and Berlin, Germany â24 September 2019â</strong> The ApacheÂ® Software Foundation (ASF), the all-volunteer developers,...</div></p>
                          <hr>
				...
				<article class="card">
					<div class="content">
						<span class="label label-danger">Twitter</span>
                         ...
                         <div>
                          <a href="https://twitter.com/TheASF/statuses/1204040372063748096">@</a>
                          <a href='http://twitter.com/TheASF'>TheASF</a>: Annual corporate gifts helps bolster the ASF's mission. Matching gift programs at <a href="http://twitter.com/business">@business</a> <a href="http://twitter.com/IBM">@IBM</a> <a href="http://twitter.com/Microsoft">@Microsoft</a> and manâ¦ <a href="https://t.co/bUWYwaw7m6">https://t.co/bUWYwaw7m6</a>
                         </div>
                         <hr>
             ...
             but other = Top Level Projects only) -->
				...
				<div class="col-sm-2" id="by_category">
					...
					<ul class="list-unstyled">
						...
						<li><a href="https://projects.apache.org/projects.html?category#database">Databases</a></li>
						...
						<li><a href="http://labs.apache.org/"
								title="A place for innovation where committers of the foundation can experiment with new ideas">Labs</a>
						</li>
								...
								<div class="row">
									<div class="col-lg-6 col-md-12 border-right">
										<ul class="list-unstyled" style="margin-bottom: 0px;">
										    	...
										    	<li><a href="http://systemml.apache.org/" title="A machine learning platform optimal for big data">SystemML</a></li>
											
										        <li class="letter-header">T</li>
										    	<li><a href="http://tajo.apache.org/" title="Big data warehouse system on Apache Hadoop">Tajo</a></li>
									...
									<div class="col-lg-6 col-md-12">
										<ul class="list-unstyled" style="margin-bottom: 0px;">
										    	...
										    	<li><a href="http://twill.apache.org/" title="Use Apache Hadoop YARN&#39;s distributed capabilities with a programming model that is similar to running threads">Twill</a></li>
