...
<!--******************** NAVBAR ********************-->
                ...
                <div class="container" role="banner" id="topNav" aria-label="topNav">
                    ...
                    <nav class="pull-right nav-collapse collapse" aria-labelledby="menu-main">
                        <ul id="menu-main" class="nav">
                            ...
                            <li><a title="EOG" href="https://www.flgov.com/" target="_blank" tabindex="4">Executive Office of the Governor</a></li>
                            <li><a title="411" href="http://411.myflorida.com/apps/411/tel411.public_411" target="_blank" tabindex="5">Florida 411</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <div id="headerwrap">
            <header class="clearfix">
                <div class="container">
                    ...
                    <br>
                    <div class="row">
                        <div class="span12" id="secondary_content" style="
								background-color: gray;
								opacity: 80%;
							">
                            <!-- Temporary Promoted Text -->
                            <br>
                            <h2>You can support Pensacola following the tragic shooting that took place at the Naval Air Station on December 6 by giving blood.</h1>
							<h2>Find locations here – <a style="color: #1414de" title="OneBlood" href="https://www.oneblood.org/donate-now/" target="_blank">https://www.oneblood.org/donate-now/</a></h2>
                            <br>
                            <!-- Temporary Promoted Text Ends -->
                        </div>
                    </div>
                </div>
            </header>
    ...
    <section  id="contact" class="single-page scrollblock" aria-labelledby="contact" role="complementary">
        <div class="container">
            ...
            <br />
            <p>
                <a class="contact-link-title" target="_blank" href="https://askalibrarian.org/getanswers/" tabindex="8">Submit a General Inquiry</a><br />
            ...
            <br />
            <p>
                <a class="contact-link-title" target="_blank" href="https://www.flgov.com/contact-governor" tabindex="9">Governor Ron DeSantis</a><br />
                <strong>For questions or comments regarding the Governor. You may also <a target="_blank" class="contact-link" href="https://www.flgov.com/email-the-governor/">email the Governor</a>.</strong>
            </p>
            <br />
            <p>
                <a class="contact-link-title" target="_blank" href="https://dos.myflorida.com/library-archives/research/florida-information/government/state-resources/state-agency-homepages/" tabindex="10">State Agencies</a><br />
                <strong>An online list of State Agencies, with links to their homepages, provided by the Department of State.</strong>
            </p>
            <br />
            <p>
                <a class="contact-link-title" target="_blank" href="http://411.myflorida.com/apps/411/tel411.public_411" tabindex="11">State of Florida Directory</a><br />
